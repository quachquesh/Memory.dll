...
namespace Memory
{
    ...
    public class Mem
    {
        ...
        /// <summary>
        /// Call Function tại địa chỉ address int
        /// </summary>
        /// <param name="address">địa chỉ function</param>
        /// <returns></returns>
        // mem.CreateRemoteThread(14024704)
        // mem.CreateRemoteThread(0xD60000)
        public IntPtr CreateRemoteThread(int address)
        {
            IntPtr intPtr;
            return Mem.CreateRemoteThread(pHandle, (IntPtr)0, 0, (UIntPtr)address, (UIntPtr)0, 0U, out intPtr);
        }
        /// <summary>
        /// Call Function tại địa chỉ address string
        /// </summary>
        /// <param name="address">địa chỉ function</param>
        /// <returns></returns>
        // mem.CreateRemoteThread("D60000")
        public IntPtr CreateRemoteThread(string address)
        {
            IntPtr intPtr;
            return Mem.CreateRemoteThread(pHandle, (IntPtr)0, 0, (UIntPtr)HexStringToInt(address), (UIntPtr)0, 0U, out intPtr);
        }

        /// <summary>
        /// Tính bước nhảy
        /// </summary>
        /// <param name="addressFrom">address hiện tại</param>
        /// <param name="addressTo">address đích</param>
        /// <returns>Giá trị Int</returns>
        // CalcJumpAddress(0xC40000, 0x444AA0) -> 4,286,597,787 -> 0xFF804A9B
        public static int CalcJumpAddress(int addressFrom, int addressTo)
        {
        ...
        /// Conver Int -> Hex
        // IntToHexString(0x86E100) -> 86E100
        public static string IntToHexString(int number)
        {
            return number.ToString("X");
        }
        /// Conver Int -> ByteArray (4 byte)
        // IntToByteArray(0x86E100) -> 00 E1 86 00
        public static byte[] IntToByteArray(int number)
        {
            return BitConverter.GetBytes(number);
        }
        /// Conver Hex -> ByteArray
        // HexStringToByteArray("86E100") -> 00 E1 86 00
        ...
        public bool InjectDll(String strDllName)
        {
            ...
            IntPtr hThread = Mem.CreateRemoteThread(pHandle, (IntPtr)null, 0, injector, allocMem, 0, out bytesout);
            if (hThread == null)
                return false;
